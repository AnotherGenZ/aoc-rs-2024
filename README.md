...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `89.1µs` | `92.4µs` |
| [Day 2](./src/bin/02.rs) | `150.6µs` | `446.7µs` |
| [Day 3](./src/bin/03.rs) | `140.8µs` | `228.2µs` |
| [Day 4](./src/bin/04.rs) | `218.3µs` | `33.8µs` |
| [Day 5](./src/bin/05.rs) | `111.6µs` | `216.9µs` |
