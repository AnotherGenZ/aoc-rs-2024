...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `83.6µs` | `85.5µs` |
| [Day 2](./src/bin/02.rs) | `141.7µs` | `416.4µs` |
| [Day 3](./src/bin/03.rs) | `135.5µs` | `210.5µs` |
| [Day 4](./src/bin/04.rs) | `201.8µs` | `32.3µs` |
| [Day 5](./src/bin/05.rs) | `191.4µs` | `534.7µs` |
